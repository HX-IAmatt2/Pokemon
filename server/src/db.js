...
const connectionString = isProduction ? DATABASE_URL : `postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}:${DB_PORT}/${DB_DATABASE}`

// console.log('>>>'.red, DATABASE_URL)
// console.log('>>>'.red, isProduction)
// console.log('>>>'.red, connectionString)
